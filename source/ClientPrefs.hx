...
class ClientPrefs {
	public static var permitirgpu:Bool = false; //Não recomendo já deixar ativado
	...
	public static var imagesPersist:Bool = false; // Nunca ative essa opção as 3 da manhã
